    ...
    <table>
            ...
            <?php foreach ($auteurs as $auteur) :; ?>
                <tr>
                    ...
                    <td>
                        <div>
                            <div> <a href="Cauteur.php?tuteur-update-id=<?= $auteur['Id-Auteur'] ?>" class="btn btn-success col-md-5">Edit</a>
                                <a href="Cauteur.php?tuteur-del-id=<?= $auteur['Id-Auteur'] ?>" class="btn btn-danger col-md-5">Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
